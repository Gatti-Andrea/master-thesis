...
#BSUB -J act_pl_desi_w             # Job name
#BSUB -M 64000                     # Memory limit (64GB)
#BSUB -R "rusage[mem=64000]"       # Resource request
#BSUB -q long                      # Queue
#BSUB -o act_planck_desidr2.out    # Output log
#BSUB -e act_planck_desidr2.err    # Error log
...
mpirun -np 4 cobaya-run act_planck_desidr2.yaml